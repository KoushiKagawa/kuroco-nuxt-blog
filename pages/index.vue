  ...
  <div>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 xl:max-w-5xl xl:px-0 m-4">    
      <div class="divide-y divide-gray-200">
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl md:text-[4rem] md:leading-[3.5rem]">Blog list</h1>
        <ul
  ...
  async asyncData({ $axios }) {
    try {
      const response = await $axios.$get(
        process.env.ROOT_API_URL + '/rcms-api/1/enbloglist'
      )
      return { response }
    } catch (e) {
